...
/*!40101 SET character_set_client = @saved_cs_client */;
CREATE TABLE IF NOT EXISTS crosspermissions_uuidcache(
  player_uuid VARCHAR(50),
  player_name VARCHAR(50),
  last_update DATETIME DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
CREATE UNIQUE INDEX crosspermissions_uuidcache_player_name_uindex ON crosspermissions_uuidcache (player_name);
CREATE UNIQUE INDEX crosspermissions_uuidcache_player_uuid_uindex ON crosspermissions_uuidcache (player_uuid);