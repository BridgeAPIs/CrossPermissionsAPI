...
public class PermissionUser extends PermissionEntity {
	public PermissionUser(DatabaseManager manager, ArrayList<PermissionGroup> parents,
			HashMap<String, Boolean> perms, HashMap<String, String> options, UUID uuid) {
		super(manager, uuid, parents, perms, options);
		this.db_prefix = "user:";
		cleanDisabledParents();
	}

    public PermissionUser(DatabaseManager manager,
                          HashMap<String, Boolean> perms, HashMap<String, String> options, UUID uuid) {
